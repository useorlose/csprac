...
namespace Practice
{
    ...
    class AllCustomerManager
    {
        ...
        {
            Customer customer1 = new Customer(501, "Jyothsna", "Hyderabad", 60000);
            Customer customer2 = new Customer(502, "Shiri", "Shiri", 70000);
            Customer customer3 = new Customer(503, "Teju", "Teju", 90000);
