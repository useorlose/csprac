...
namespace Good
{
    ...
    class CustomerManagerExam
    {
        ...
        static void InitializeComponent()
        {
            ...
            mgr.AddCustomer(new Customer { CustomerID = 901, CustomerName = "jyothsna", Address = "hyd", Salary = 60000 });
            mgr.AddCustomer(new Customer { CustomerID = 902, CustomerName = "shiri", Address = "tirupathi", Salary = 70000 });
            mgr.AddCustomer(new Customer { CustomerID = 903, CustomerName = "teju", Address = "banglore", Salary = 80000 });
            mgr.AddCustomer(new Customer { CustomerID = 904, CustomerName = "shreya", Address = "mysore", Salary = 90000 });
        }
        ...
        {
            string name = GetData.getString("Enter the complete name or part of the name to search");
            Customer[] books = mgr.SearchByName(name);
